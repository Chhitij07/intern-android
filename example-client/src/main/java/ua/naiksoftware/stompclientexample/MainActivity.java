package com.example.internoauth2;
...
public class MainActivity extends Activity {
    ...
    private static String CLIENT_ID = "910931927243-om7d3bn5ahakov3c7v0lf2kc0a8okgek.apps.googleusercontent.com";
    //Use your own client id
    private static String CLIENT_SECRET ="BJ2EoCaGw5dF8zn0-YirhQZ4";
    //Use your own client secret
    private static String REDIRECT_URI="http://localhost:8181/google/login";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        auth.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                auth_dialog.setContentView(R.layout.auth_diag);
