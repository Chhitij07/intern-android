...
//        vehicle=i.getStringExtra("vehicle").toLowerCase();
    ...
    {
        Log.i("Restart","The app has been restarted");
    ...
    {
        Log.i("Resume","The app has been resumed");
    ...
    public void connectStomp() {
        ...
        headers.add(new StompHeader("X-AUTH-TOKEN",AccessToken));
        //StompHeader headers=new StompHeader("X-AUTH-TOKEN",AccessToken);
        Map<String,String> header=new HashMap<>() ;
        header.put("X-AUTH-TOKEN",AccessToken);
        mStompClient = Stomp.over(Stomp.ConnectionProvider.JWS, "ws://192.168.1.5:8181" +
    ...
    //mStompClient = Stomp.over(WebSocket.class, "ws://" + ANDROID_EMULATOR_LOCALHOST
     //           + ":" + RestClient.SERVER_PORT + "/gs-guide-websocket/websocket",param);
        ...
        sendEchoViaStomp();
         mStompClient.topic("/user/queue/location/", headers)
...
//        mStompClient.send("/app/location/subscribe", data)
    ...
    protected void onStop()
    {
        ...
        Log.i("Stop","The app has stopped");
    ...
    protected void onPause() {
        Log.i("Pause","The app has paused");
        super.onPause();
    }

    @Override
    protected void onDestroy() {
        Log.i("Destroy","The app has been Destroyed");
        mStompClient.disconnect();
        super.onDestroy();
    }
